...
#
# Scan a directory and search for dupe files. Take list of full dir names.
#
...
# * check dupe code ugly
# * factor out code to process a file  -seperate from other code
# * cleanup code for insert hash, check dupes  -ugly
#
#
...
# Ugly  -use global to make code cleaner
my @file_objs;
my %size_hash;
